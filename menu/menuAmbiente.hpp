...
void menu_ambiente() {
	...
	system("color 47");
		...
		gotoxy(20, 4); cout << "|___________________________________________________________________________________|" ; 
		gotoxy(20, 5); cout << "|     _____   ______   ______   _______  _____    _      _____   ______    ______   |" ; 
		gotoxy(20, 6); cout << "|    |   __| |  __  | |  __  | |__   __||  ___|  | |    |  ___| |  __  |  |  __  |  |" ; 
		gotoxy(20, 7); cout << "|    |  |    | |__| | | |__| |    | |   | |__    | |    | |__   | |__| |  | |__| |  |" ; 
		gotoxy(20, 8); cout << "|    |  |    |  __  | |  _   |    | |   |  __|   | |    |  __|  |  _   |  |  __  |  |" ; 
		gotoxy(20, 9); cout << "|    |  |__  | |  | | | | | |     | |   | |___   | |__  | |___  | | | |   | |  | |  |" ; 
		gotoxy(20, 10);cout << "|    |_____| |_|  |_| |_|  |_|    |_|   |_____|  |____| |_____| |_|  |_|  |_|  |_|  |" ; 
		gotoxy(20, 11);cout << "|___________________________________________________________________________________|" ; 
		gotoxy(32, 11); cout << "+ ---------------------------- +---------------------------- +";
